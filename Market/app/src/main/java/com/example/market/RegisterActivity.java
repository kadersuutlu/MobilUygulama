...
public class RegisterActivity extends AppCompatActivity {
    ...
    private EditText eMail, password,adSoyad,phoneNumber;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        kayitOl.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                txtNameSurname=adSoyad.getText().toString();
        ...
        if (!TextUtils.isEmpty(txtEmail) && !TextUtils.isEmpty(txtPassword)) {
            mAuth.createUserWithEmailAndPassword(txtEmail, txtPassword)
                    .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            if (task.isSuccessful()) {
                                Toast.makeText(RegisterActivity.this, "Kayıt işlemi başarılı giriş sayfasına yönlendiriliyorsunuz", Toast.LENGTH_SHORT).show();
